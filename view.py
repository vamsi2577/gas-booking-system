...
bookTable = "register" #register Table
...
def search():
    ...
    Label(labelFrame, text="%-25s%-25s%-15s%-30s"%('BID','CustomerID','Cylinders','Address',),bg='black',fg='white').place(relx=0.07,rely=0.1)
    Label(labelFrame, text="----------------------------------------------------------------------",bg='black',fg='white').place(relx=0.05,rely=0.2)
    
    searchSql = "select * from "+bookTable+" where cusid = '"+custid+"'"
    try:
    ...
    quitBtn = Button(root,text="< Back",bg='#455A64', fg='white', command=close_window)
...
def searchBook(): 
    ...
    headingLabel = Label(headingFrame2, text="VIEW BOOKINGS", fg='black')
    headingLabel.place(relx=0.25,rely=0.15, relwidth=0.5, relheight=0.5)   
        
    # enter customer id
    lb1 = Label(labelFrame,text="Enter customerID : ", bg='black', fg='white')
    ...
    quitBtn = Button(root,text="Quit",bg='#455A64', fg='white', command=close_window)
